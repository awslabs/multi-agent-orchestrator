...
from agents import create_sonnet_3_agent, create_haiku_agent, create_llama_agent
...
orchestrator.add_agent(create_sonnet_3_agent())
orchestrator.add_agent(create_haiku_agent())
orchestrator.add_agent(create_llama_agent())
