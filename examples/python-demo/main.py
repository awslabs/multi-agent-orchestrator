...
async def handle_request(orchestrator, user_input, user_id, session_id):
    response:AgentResponse = await orchestrator.route_request(user_input, user_id, session_id)
