...
- `toolConfig`/`tool_config`: Defines tools the agent can use and how to handle their responses ([See Tools for Agents for seamless tool definition](/multi-agent-orchestrator/agents/tools))
