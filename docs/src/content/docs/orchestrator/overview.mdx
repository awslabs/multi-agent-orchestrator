...
4. **setClassifier**
   ...
   - **Why use it**: When you want to use a different classifier than the default [BedrockClassifier](/multi-agent-orchestrator/classifiers/built-in/bedrock-classifier/), either by using another built-in classifier (like the [AnthropicClassifier](/multi-agent-orchestrator/classifiers/built-in/anthropic-classifier/) or [OpenAIClassifier](/multi-agent-orchestrator/classifiers/built-in/openai-classifier/)) or by implementing your own [custom classifier](/multi-agent-orchestrator/classifiers/custom-classifier/).
