...
The Multi-Agent Orchestrator System offers flexible tool solution.
...
## Integrating Tools with Agents with a custom tool handler
...
<Tabs syncKey="runtime">
  ...
  <TabItem label="Python" icon="seti:python">
    ...
    from multi_agent_orchestrator.utils.tool import Tools
